...
#define PR_BUILD_OPTS " '--host=mips-linux' '--target=mips-linux' '--build=i686-pc-linux' 'CFLAGS=-I/home/rtlac/userapps/nasapp/rootfs/root.5281.3465/include -DUSE_IPTIME_WELCOME -DHAVE_LC_MESSAGES -DEFM_ROUTER_PATCH' 'LDFLAGS=-L/home/rtlac/userapps/nasapp/rootfs/root.5281.3465/lib -liconv' '--sbindir=/sbin' '--sharedstatedir=/usr/share' '--localstatedir=/var/run' '--sysconfdir=/etc' '--enable-autoshadow' '--disable-cap' '--disable-auth-file' '--disable-auth-pam' '--enable-largefile' '--enable-nls' '--with-modules=mod_codeconv:mod_df' '--prefix=/home/rtlac/userapps/nasapp/source/proftpd-1.3.4d/install' 'build_alias=i686-pc-linux' 'host_alias=mips-linux' 'target_alias=mips-linux' 'CC=rsdk-linux-gcc'"

/* Define to be the build CFLAGS.  */
#define PR_BUILD_CFLAGS "-I/home/rtlac/userapps/nasapp/rootfs/root.5281.3465/include -DUSE_IPTIME_WELCOME -DHAVE_LC_MESSAGES -DEFM_ROUTER_PATCH -Wall"

/* Define to be the build LDLAGS.  */
#define PR_BUILD_LDFLAGS "-L$(top_srcdir)/lib -L/home/rtlac/userapps/nasapp/rootfs/root.5281.3465/lib -liconv "
...
#define PR_INCLUDE_DIR "/home/rtlac/userapps/nasapp/source/proftpd-1.3.4d/install/include"
#endif /* PR_INCLUDE_DIR */

#ifndef PR_LIBEXEC_DIR
#define PR_LIBEXEC_DIR "/home/rtlac/userapps/nasapp/source/proftpd-1.3.4d/install/libexec"
#endif /* PR_LIBEXEC_DIR */

#ifndef PR_LOCALE_DIR
#define PR_LOCALE_DIR "/home/rtlac/userapps/nasapp/source/proftpd-1.3.4d/install/share/locale"
#endif /* PR_LOCALE_DIR */
